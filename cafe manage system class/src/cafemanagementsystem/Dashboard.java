...
public class Dashboard extends JFrame implements ActionListener {
    ...
    String loggedInStudentId; // store the ID passed from Login

    // Constructor to accept studentId
    ...
    private void initUI() {
        setTitle("Cafe Order Page - " + (loggedInStudentId != null ? loggedInStudentId : ""));
        setSize(850, 700);
        setLayout(null);
